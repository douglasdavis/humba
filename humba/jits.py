...
@nb.jit(nb.float32[:](nb.float32[:], nb.int64, nb.float64, nb.float64, nb.boolean), nopython=True)
...
@nb.jit(nb.float64[:](nb.float64[:], nb.int64, nb.float64, nb.float64, nb.boolean), nopython=True)
